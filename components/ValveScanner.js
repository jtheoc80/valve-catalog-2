...
const ValveScanner = ({ onClose }) => {
  ...
  const startCamera = async () => {
    try {
      ...
      setError('Unable to access camera directly. Using file upload instead.');
    }
  };
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <label
              ...
              className="w-full flex items-center justify-center gap-2 bg-gray-600 text-white px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors cursor-pointer"
            >
              <Upload size={20} />
              Choose from Gallery
            </label>

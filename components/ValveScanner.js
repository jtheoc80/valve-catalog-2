...
export default async function handler(req, res) {
  ...
  try {
      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: "You are a valve identification expert. Analyze this valve image and provide detailed specifications in this exact JSON format: { size: string, material: string, brand: string, partNumber: string, specifications: { pressureRating: string, temperature: string, connection: string, stemType: string }, features: string[] }"
            },
            {
              type: "image_url",
              image_url: {
    ...
    try {
      ...
      console.log('Parsed JSON:', analysisJson);

...
// Update the simulation to include detailed analysis
const simulateAnalysis = async (imageData) => {
  const steps = [
    { message: 'Initializing image analysis...', delay: 800 },
    { message: 'Detecting valve characteristics...', delay: 1000 },
    { message: 'Measuring dimensions...', delay: 800 },
    { message: 'Identifying materials...', delay: 900 },
    { message: 'Matching brand patterns...', delay: 700 },
    { message: 'Reading part numbers...', delay: 800 },
    { message: 'Finalizing analysis...', delay: 500 }
  ];
    ...
    if (file) {
      ...
      try {
        ...
        reader.onload = async (e) => {
          ...
          const results = await simulateAnalysis(e.target?.result);
